...
- Severity \+ risk-assessment outcome fields: see Sections 4-5 of Part I. *Proposal*: make explicit in the form the link between the risk-assessment outcome (high risk / risk / unlikely risk) and the obligations that follow (Article 33 notification to the DPA / Article 34 communication to data subjects), with contextual guidance. Multi-value fields: the template appears to permit multiple selections explicitly on only one field, while several enumerated fields are inherently multi-valued. A single breach commonly affects more than one nature dimension (confidentiality, integrity and availability can be compromised together \- the template itself provides separate C/I/A sub-types), more than one category of personal data and of data subjects (Article 33(3)(a) refers to "categories" in the plural), and entails several likely consequences and several security and remediation measures. Forcing a single choice on these fields loses information, distorts the controller's description and undermines the comparability of aggregate statistics. Proposal: the EDPB should explicitly enable multiple selection on the fields that are inherently multi-valued \- in particular the nature of the breach (C/I/A), the categories of personal data and of data subjects, the likely consequences and the measures in place or proposed \- while keeping single selection where a single primary value is appropriate (notably the primary incident type, to preserve the statistical comparability of the 25-type taxonomy). The reference implementation models these fields as arrays.
...
The Digital Omnibus proposes an ENISA-operated single entry point ('report once, share many') routing incident and breach notifications across NIS2, GDPR, DORA, eIDAS and CER: the entity notifies once, and the back-end routes the submission to the relevant authorities. The single entry point is part of the broader Digital Omnibus package: a European Commission proposal (19 November 2025\) introducing a proposed new Article 23a of the NIS2 Directive and an ENISA-operated entry point. It is still under the ordinary legislative procedure, with adoption expected in the course of 2026; if adopted, the single entry point would become available approximately 18 months after the new measures enter into force (extendable to 24 months if the Commission finds the portal does not yet meet the required integrity, reliability and confidentiality standards). The EDPB breach template could/should be designed **upfront** to be compatible with that single-entry-point data model, so that one structured submission can satisfy multiple regimes. This turns the template from a GDPR silo into the GDPR node of a pan-regulatory reporting fabric \- aligning with the EU Commission's own simplification agenda.

**Important framing: the single entry point is, at the time of writing, a European Commission proposal (19 November 2025\) still under the ordinary legislative procedure, with adoption expected in the course of 2026\. It is not yet adopted law (and is distinct from the 'Digital Omnibus on AI' file, which the European Parliament approved on 16 June 2026). This recommendation is therefore made strictly as forward-compatibility / anticipation of a proposal in progress, not as compliance with an existing obligation.**
...
17. **\[forward-looking \- proposal not yet adopted\]** Design the template forward-compatibly with the Digital Omnibus single reporting entry point (one structured submission serving NIS2/GDPR/DORA/eIDAS/CER). NB: the single reporting entry point is a European Commission proposal (a proposed Article 23a NIS2, 19 November 2025\) still under the ordinary legislative procedure, with adoption expected in the course of 2026; framed here as anticipation, not existing law.   
...
20. Maintain the controlled vocabulary centrally with stable, language-independent keys to ensure multilingual consistency across 27+ DPAs. 21\. Enable multiple-selection (multi-value) cardinality on the inherently multi-valued fields \- nature of the breach (C/I/A), categories of personal data and of data subjects, likely consequences, and measures in place/proposed \- keeping single-selection for the primary incident type to preserve taxonomy comparability. The reference implementation already represents these fields as arrays.
